...
function getEmployeeNames() {
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    if (typeof name === 'string' && isNaN(name) && name !== 'Team' && name !== 'Week' && name !== 'Trading Hours' && name !== 'ASM' && name !== 'Supervisor' && name !== 'Retail Expert'&& name !== 'Store Manager' && name !== 'Retail Stylist'&& name !== 'Stylist'&& name !== 'Expert') {
